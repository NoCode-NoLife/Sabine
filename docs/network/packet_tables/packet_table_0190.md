...
CZ_REQ_EXPEL_GROUP_MEMBER                  | 0x009D   | 30
ZC_ADD_MEMBER_TO_GROUP                     | 0x009E   | 79
ZC_DELETE_MEMBER_FROM_GROUP                | 0x009F   | 31
ZC_NOTIFY_HP_TO_GROUPM                     | 0x00A0   | 10
ZC_NOTIFY_POSITION_TO_GROUPM               | 0x00A1   | 10
CZ_REQUEST_CHAT_PARTY                      | 0x00A2   | -1
ZC_NOTIFY_CHAT_PARTY                       | 0x00A3   | -1
ZC_MVP_GETTING_ITEM                        | 0x00A4   | 18
ZC_MVP_GETTING_SPECIAL_EXP                 | 0x00A5   | 6
ZC_MVP                                     | 0x00A6   | 6
ZC_THROW_MVPITEM                           | 0x00A7   | 2
ZC_SKILLINFO_UPDATE                        | 0x00A8   | 9
ZC_SKILLINFO_LIST                          | 0x00A9   | -1
ZC_ACK_TOUSESKILL                          | 0x00AA   | 10
ZC_ADD_SKILL                               | 0x00AB   | 39
CZ_UPGRADE_SKILLLEVEL                      | 0x00AC   | 4
CZ_USE_SKILL                               | 0x00AD   | 10
ZC_NOTIFY_SKILL                            | 0x00AE   | 31
ZC_NOTIFY_SKILL_POSITION                   | 0x00AF   | 35
CZ_USE_SKILL_TOGROUND                      | 0x00B0   | 10
ZC_NOTIFY_GROUNDSKILL                      | 0x00B1   | 18
CZ_CANCEL_LOCKON                           | 0x00B2   | 2
ZC_STATE_CHANGE                            | 0x00B3   | 13
ZC_USE_SKILL                               | 0x00B4   | 15
CZ_SELECT_WARPPOINT                        | 0x00B5   | 20
ZC_WARPLIST                                | 0x00B6   | 52
CZ_REMEMBER_WARPPOINT                      | 0x00B7   | 2
ZC_ACK_REMEMBER_WARPPOINT                  | 0x00B8   | 3
ZC_SKILL_ENTRY                             | 0x00B9   | 11
ZC_SKILL_DISAPPEAR                         | 0x00BA   | 6
ZC_NOTIFY_CARTITEM_COUNTINFO               | 0x00BB   | 14
ZC_CART_EQUIPMENT_ITEMLIST                 | 0x00BC   | -1
ZC_CART_NORMAL_ITEMLIST                    | 0x00BD   | -1
ZC_ADD_ITEM_TO_CART                        | 0x00BE   | 32
ZC_DELETE_ITEM_FROM_CART                   | 0x00BF   | 8
CZ_MOVE_ITEM_FROM_BODY_TO_CART             | 0x00C0   | 8
CZ_MOVE_ITEM_FROM_CART_TO_BODY             | 0x00C1   | 8
CZ_MOVE_ITEM_FROM_STORE_TO_CART            | 0x00C2   | 8
CZ_MOVE_ITEM_FROM_CART_TO_STORE            | 0x00C3   | 8
CZ_REQ_CARTOFF                             | 0x00C4   | 2
ZC_CARTOFF                                 | 0x00C5   | 2
ZC_ACK_ADDITEM_TO_CART                     | 0x00C6   | 3
ZC_OPENSTORE                               | 0x00C7   | 4
CZ_REQ_CLOSESTORE                          | 0x00C8   | 2
CZ_REQ_OPENSTORE                           | 0x00C9   | -1
CZ_REQ_BUY_FROMMC                          | 0x00CA   | 6
ZC_STORE_ENTRY                             | 0x00CB   | 86
ZC_DISAPPEAR_ENTRY                         | 0x00CC   | 6
ZC_PC_PURCHASE_ITEMLIST_FROMMC             | 0x00CD   | -1
CZ_PC_PURCHASE_ITEMLIST_FROMMC             | 0x00CE   | -1
ZC_PC_PURCHASE_RESULT_FROMMC               | 0x00CF   | 7
ZC_PC_PURCHASE_MYITEMLIST                  | 0x00D0   | -1
ZC_DELETEITEM_FROM_MCSTORE                 | 0x00D1   | 6
CZ_PKMODE_CHANGE                           | 0x00D2   | 3
ZC_ATTACK_FAILURE_FOR_DISTANCE             | 0x00D3   | 16
ZC_ATTACK_RANGE                            | 0x00D4   | 4
ZC_ACTION_FAILURE                          | 0x00D5   | 4
ZC_EQUIP_ARROW                             | 0x00D6   | 4
ZC_RECOVERY                                | 0x00D7   | 6
ZC_USESKILL_ACK                            | 0x00D8   | 24
CZ_ITEM_CREATE                             | 0x00D9   | 26
CZ_MOVETO_MAP                              | 0x00DA   | 18
