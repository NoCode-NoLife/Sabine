...
namespace Sabine.Zone.Commands
{
	...
	public partial class ChatCommands : CommandManager<ChatCommand, CommandFunc>
	{
		...
		public void Add(string name, string usage, string description, CommandFunc func)
		{
		...
		/// <returns></returns>
		public bool TryExecute(PlayerCharacter character, string message)
		{
			var prefix = ZoneServer.Instance.Conf.Commands.Prefix;
